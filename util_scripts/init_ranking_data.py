...
from django.db.models import Window, F, Min, Max  # noqa: E402
from django.db.models.functions import DenseRank  # noqa: E402
from django.utils import timezone  # noqa: E402

application = get_wsgi_application()

from mosquito_alert.awards.xp_scoring import get_user_class  # noqa: E402
from mosquito_alert.users.models import TigaUser  # noqa: E402
from mosquito_alert.stats.models import RankingData  # noqa: E402
...
def init_ranking_data():
    ...
    scores = users_qs.aggregate(min_score=Min("score_v2"), max_score=Max("score_v2"))
    ...
    for user in ranked_users.iterator():
        ranking_data_instances.append(
            RankingData(
                user_uuid=user.pk,
                class_value=get_user_class(
                    min=min_score, max=max_score, user_score=user.score_v2
                )["value"],
                rank=user.rank,
