...
urlpatterns += i18n_patterns('',
    ...
    url(r'^site_map/(?P<type>\w+)/$', views.show_site_map),
    ...
    url(r'^x/$', views.show_validated_report_map, name='validated_report_map'),
    url(r'^x/(?P<type>\w+)/$', views.show_validated_report_map),
