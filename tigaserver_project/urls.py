...
urlpatterns += [
    ...
    path('scoring/bn/', RedirectView.as_view(url='/bn/scoring/', permanent=False), name="scoring_bn"),
    path('scoring/sv/', RedirectView.as_view(url='/sv/scoring/', permanent=False), name="scoring_sv"),
