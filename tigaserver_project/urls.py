...
urlpatterns += i18n_patterns(
    ...
    path('experts/user_outline/<user_uuid>/', user_outline, name='user_outline'),
    ...
    path('notifications/detail/<user_uuid>/', notification_detail, name='notification_detail'),
