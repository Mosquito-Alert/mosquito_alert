...
from tigacrafting.views import show_validated_photos, show_processing, annotate_tasks, movelab_annotation, movelab_annotation_pending, expert_report_annotation, expert_report_status
...
urlpatterns += i18n_patterns('',
    ...
    url(r'^expert_status/$', expert_report_status, name='expert_report_status'),
