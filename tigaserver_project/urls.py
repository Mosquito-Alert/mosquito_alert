...
urlpatterns += i18n_patterns('',
    ...
    url(r'^movelabmap/(?P<report_type>\w+)/(?P<category>\w+)/$', views.show_map, {'detail': 'detailed'}, name='webmap.show_map_detailed'),
    url(r'^movelabmap/(?P<report_type>\w+)/$', views.show_map, {'detail': 'detailed'}),
    url(r'^movelabmap/$', views.show_map, {'detail': 'detailed'}),
    url(r'^webmap/(?P<report_type>\w+)/(?P<category>\w+)/$', views.show_map, name='webmap.show_map'),
    url(r'^webmap/c$', views.show_map),
