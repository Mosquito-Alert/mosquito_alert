...
urlpatterns = [
    ...
    path('privacy/al/', RedirectView.as_view(url='/al/privacy/', permanent=False)),
    ...
    path('scoring/al/', RedirectView.as_view(url='/al/scoring/', permanent=False), name="scoring_al"),
    ...
    path('about_us/al/', RedirectView.as_view(url='/al/about_us/', permanent=False), name="about_us_al"),
    ...
    path('project_about/al/', RedirectView.as_view(url='/al/project_about/', permanent=False), name="project_about_al"),
