...
urlpatterns += i18n_patterns('',
    ...
    url(r'^movelab_annotation_pending/$', movelab_annotation, {'type': 'pending'}, name='movelab_annotation_pending'),
    url(r'^movelab_annotation_pending/(?P<tasks_per_page>[0-9]+)/$', movelab_annotation, {'type': 'pending'},name='movelab_annotation_pending_tasks_per_page'),
    url(r'^movelab_annotation_pending/(?P<tasks_per_page>[0-9]+)/(?P<scroll_position>\w+)/$', movelab_annotation, {'type': 'pending'},name='movelab_annotation_pending_scroll_position'),
