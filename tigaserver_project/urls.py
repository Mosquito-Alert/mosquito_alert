...
urlpatterns += i18n_patterns('',
    ...
    url(r'^webmap/$', views.show_map, name='webmap.show_map_defaults'),
    url(r'^coverage_map/$', views.show_new_coverage_map, name='coverage_map'),
    url(r'^site_map/$', views.show_site_map, name='site_map'),
    url(r'^site_map/(?P<type>\w+)/$', views.show_site_map, name='site_map_type'),
    ...
    url(r'^x/$', views.show_adult_map, name='adult_map'),
    url(r'^x/(?P<type>\w+)/$', views.show_adult_map, name='adult_map_type'),
    url(r'^xembedded/$', views.show_embedded_adult_map, name='embedded_adult_map'),
    url(r'^xembedded/(?P<legend>\w+)/$', views.show_embedded_adult_map, name='embedded_adult_map_type'),
