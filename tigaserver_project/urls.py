...
urlpatterns = [
    ...
    path('about_us/mk/', RedirectView.as_view(url='/mk/about_us/', permanent=False), name="about_mk_hr"),
    path('about_us/sr/', RedirectView.as_view(url='/sr/about_us/', permanent=False), name="about_sr_hr"),
    path('about_us/lb/', RedirectView.as_view(url='/lb/about_us/', permanent=False), name="about_lb_hr"),
