...
urlpatterns = patterns('',
    ...
    url(r'^policies/zh/$', RedirectView.as_view(url='/zh/policies/', permanent=False)),
    ...
    url(r'^terms/zh/$', RedirectView.as_view(url='/zh/terms/', permanent=False)),
    ...
    url(r'^privacy/zh/$', RedirectView.as_view(url='/zh/privacy/', permanent=False)),
