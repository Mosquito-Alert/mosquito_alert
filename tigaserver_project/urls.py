...
from stats.views import show_usage, workload_stats, report_stats, registration_stats, report_stats_ccaa, report_stats_ccaa_pie, mosquito_ccaa_rich
...
urlpatterns += i18n_patterns('',
    ...
    url(r'^stats/mosquito_ccaa_rich/$', mosquito_ccaa_rich, name='mosquito_ccaa_rich'),
