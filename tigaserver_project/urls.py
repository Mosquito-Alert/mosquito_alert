...
urlpatterns += i18n_patterns('',
    ...
    url(r'^expert_validation/$', annotate_tasks, name='annotate_tasks_new_all'),
    url(r'^expert_validation/(?P<which>\w+)/$', annotate_tasks, name='annotate_tasks_all'),
    url(r'^expert_validation/(?P<which>\w+)/(?P<how_many>[0-9]+)/$', annotate_tasks, name='annotate_tasks'),
