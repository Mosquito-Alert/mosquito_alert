...
urlpatterns += i18n_patterns('',
    ...
    url(r'^webmap/embedded/$', views.show_filterable_report_map, {'navbar': 'off', 'legend': 'on'}),
    ...
    url(r'^bcn/$', views.show_filterable_report_map, {'min_lat': 41.321049, 'min_lon': 2.052380, 'max_lat': 41.468609, 'max_lon':2.225610}),
