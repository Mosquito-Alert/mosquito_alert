...
class StormDrain(models.Model):
    ...
    water = models.BooleanField(max_length=10, blank=True, null=True)
    sand = models.BooleanField(max_length=10, blank=True, null=True)
    treatment = models.BooleanField(max_length=10, blank=True, null=True)
    species2 = models.BooleanField(max_length=10, blank=True, null=True)
    species1 = models.BooleanField(max_length=10, blank=True, null=True)
    activity = models.BooleanField(max_length=10, blank=True, null=True)
