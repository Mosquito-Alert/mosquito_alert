...
add = {
  ...
  'modal.firstvisit.content': '<p>On the private interactive map you can check the mosquito data sent by citizens, through the Mosquito Alert app, and validated by entomology professionals. You can also consult data that have not yet been validated, as well as data that is not public because it contains sensitive information, but potentially useful for monitoring and controlling these species. The tool not only allows you to view data, also filter it according to your interests, prepare personalized reports or even download them. In addition, you can send notifications directly to citizens through the Mosquito Alert app, selecting observations on the map.</p>' +
    '<ul>' +
