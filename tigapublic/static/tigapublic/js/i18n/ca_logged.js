...
add = {
  ...
  'modal.firstvisit.content': '<p>Aquí podràs consultar les dades de mosquits enviats per la ciutadania, mitjançant l\'app Mosquito Alert, i validats per professionals de l\'entomologia, així com dades que no es fan públiques per contenir informació considerada sensible, però potencialment útil per al seguiment i control d\'aquestes espècies. L\'eina no sols et permet <b>visualitzar dades</b>, sino també <b>filtrar-les</b> segons els teus interessos, <b>elaborar informes personalitzats</b> o fins i tot <b>descarregar-los</b>. A més, podràs enviar notificacions directament a la ciutadania a través de l\'app de Mosquito Alert, seleccionant observacions en el mapa.</p>' +
    '<ul>' +
