...
class TestIdentificationTaskPredictionAPI:
    ...
    @pytest.mark.parametrize("is_final_prediction", [False, True])
    def test_is_final_prediction_False_does_not_set_identification_task(self, api_client, identification_task, is_final_prediction):
        ...
        response = api_client.patch(
            ...
            data={
                "is_final_prediction": is_final_prediction
            },
            format='json'
        )
        ...
        assert (identification_task.result_source == IdentificationTask.ResultSource.AI) == is_final_prediction
        assert identification_task.report.published == is_final_prediction
