...
TIGER_CATEGORIES = ((-3, 'Unclassified'), (2, 'Definitely a tiger mosquito'), (1, 'Probably a tiger mosquito'),  (0, 'Not sure'), (-1, 'Probably not a tiger mosquito'), (-2, 'Definitely not a tiger mosquito'))

SITE_CATEGORIES = ((-3, 'Unclassified'), (2, 'Definitely a breeding site'), (1, 'Probably a breeding site'), (0, 'Not sure'), (-1, 'Probably not a breeding site'), (-2, 'Definitely not a breeding site'))
...
class ExpertReportAnnotation(models.Model):
    ...
    tiger_certainty_category = models.IntegerField('Tiger Certainty', choices=TIGER_CATEGORIES, default=-3, blank=True, null=True, help_text='Your degree of belief that at least one photo shows a tiger mosquito')
    ...
    site_certainty_category = models.IntegerField('Site Certainty', choices=SITE_CATEGORIES, default=-3, blank=True, null=True, help_text='Your degree of belief that at least one photo shows a tiger mosquito breeding site')
