...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ExpertReportAnnotation.validation_complete'
        db.add_column(u'tigacrafting_expertreportannotation', 'validation_complete',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'ExpertReportAnnotation.best_photo'
        db.add_column(u'tigacrafting_expertreportannotation', 'best_photo',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='expert_report_annotations', null=True, to=orm['tigaserver_app.Photo']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ExpertReportAnnotation.validation_complete'
        db.delete_column(u'tigacrafting_expertreportannotation', 'validation_complete')

        # Deleting field 'ExpertReportAnnotation.best_photo'
        db.delete_column(u'tigacrafting_expertreportannotation', 'best_photo_id')
    ...
    models = {
        ...
        u'tigacrafting.annotation': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 6, 19, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 6, 19, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
        ...
        u'tigaserver_app.photo': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'4b8fc4f9-ff27-48b0-8c5e-cf74cd41b8dd'", 'max_length': '36'})
        },
