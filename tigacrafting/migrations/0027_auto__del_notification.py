...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.create_table(u'tigacrafting_notification', (
            ...
            ('expert', self.gf('django.db.models.fields.related.ForeignKey')(related_name='expert_reports', to=orm['auth.User'], blank=True)),
            ('expert_html', self.gf('django.db.models.fields.TextField')()),
            ('report', self.gf('django.db.models.fields.related.ForeignKey')(related_name='report_notifications', to=orm['tigaserver_app.Report'], blank=True)),
    ...
    models = {
        ...
        u'tigaserver_app.photo': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'bb110a8c-53a0-4cd2-90f8-01b7d1732c12'", 'max_length': '36'})
        },
