...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ExpertReportAnnotation.reviewed'
        db.delete_column(u'tigacrafting_expertreportannotation', 'reviewed')

        # Adding field 'ExpertReportAnnotation.revise'
        db.add_column(u'tigacrafting_expertreportannotation', 'revise',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'ExpertReportAnnotation.reviewed'
        db.add_column(u'tigacrafting_expertreportannotation', 'reviewed',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'ExpertReportAnnotation.revise'
        db.delete_column(u'tigacrafting_expertreportannotation', 'revise')
    ...
    models = {
        ...
        u'tigaserver_app.photo': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'49309b8c-bbd2-4b57-95c9-ad89f639faed'", 'max_length': '36'})
        },
