...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.create_table(u'tigacrafting_validation', (
            ('species', self.gf('django.db.models.fields.related.ForeignKey')(related_name='validations', null=True, to=orm['tigacrafting.Species'], blank=True)),
    ...
    models = {
        ...
        u'tigaserver_app.photo': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'1d0ba02d-f595-4f9d-ac9b-ec2dc0d6c198'", 'max_length': '36'})
        },
