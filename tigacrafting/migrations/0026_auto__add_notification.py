...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'tigacrafting_notification', (
            ...
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='user_reports', to=orm['auth.User'])),
            ('expert', self.gf('django.db.models.fields.related.ForeignKey')(related_name='expert_reports', blank=True, to=orm['auth.User'])),
        ...
        db.send_create_signal(u'tigacrafting', ['Notification'])


    def backwards(self, orm):
        # Deleting model 'Notification'
        db.delete_table(u'tigacrafting_notification')
    ...
    models = {
        ...
        u'tigacrafting.annotation': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 6, 20, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 6, 20, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
        ...
        u'tigacrafting.notification': {
            ...
            'expert': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'expert_reports'", 'blank': 'True', 'to': u"orm['auth.User']"}),
            ...
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'user_reports'", 'to': u"orm['auth.User']"})
        },
        ...
        u'tigaserver_app.photo': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'cf6e6c0a-c7a3-4354-8b18-bf96e2ca1d3f'", 'max_length': '36'})
        },
