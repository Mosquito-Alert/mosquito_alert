...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserStat.license_accepted'
        db.add_column(u'tigacrafting_userstat', 'license_accepted',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserStat.license_accepted'
        db.delete_column(u'tigacrafting_userstat', 'license_accepted')
    ...
    models = {
        ...
        u'tigacrafting.annotation': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2020, 6, 9, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2020, 6, 9, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
        ...
        u'tigacrafting.userstat': {
            ...
            'license_accepted': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
        ...
        u'tigaserver_app.photo': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'8454d273-bd50-4c21-9d25-232841324ad7'", 'max_length': '36'})
        },
