...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ExpertReportAnnotation.aegypti_certainty_category'
        db.add_column(u'tigacrafting_expertreportannotation', 'aegypti_certainty_category',
                      self.gf('django.db.models.fields.IntegerField')(default=None, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ExpertReportAnnotation.aegypti_certainty_category'
        db.delete_column(u'tigacrafting_expertreportannotation', 'aegypti_certainty_category')
    ...
    models = {
        ...
        u'tigacrafting.annotation': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 2, 29, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 2, 29, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
        ...
        u'tigaserver_app.photo': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'1d7df113-57d6-476c-b065-88dde8ddad0b'", 'max_length': '36'})
        },
