...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'UserMethods'
        db.create_table(u'tigacrafting_usermethods', (
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True, primary_key=True)),
        ))
        db.send_create_signal(u'tigacrafting', ['UserMethods'])


    def backwards(self, orm):
        # Deleting model 'UserMethods'
        db.delete_table(u'tigacrafting_usermethods')
    ...
    models = {
        ...
        u'tigacrafting.annotation': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 7, 15, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 7, 15, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
        ...
        u'tigacrafting.usermethods': {
            'Meta': {'object_name': 'UserMethods'},
        ...
        u'tigaserver_app.photo': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'c06d0dea-5f2f-431c-9a9a-e5f3aa711811'", 'max_length': '36'})
        },
