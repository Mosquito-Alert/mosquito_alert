...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserStat.national_supervisor_of'
        db.add_column(u'tigacrafting_userstat', 'national_supervisor_of',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['tigaserver_app.EuropeCountry'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserStat.national_supervisor_of'
        db.delete_column(u'tigacrafting_userstat', 'national_supervisor_of_id')
    ...
    models = {
        ...
        u'tigacrafting.annotation': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2020, 2, 26, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2020, 2, 26, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
        ...
        u'tigaserver_app.photo': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'94e6c25d-0b09-4eab-81be-1c8fb91a7dee'", 'max_length': '36'})
        },
