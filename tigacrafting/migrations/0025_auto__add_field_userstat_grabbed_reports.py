...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserStat.grabbed_reports'
        db.add_column(u'tigacrafting_userstat', 'grabbed_reports',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserStat.grabbed_reports'
        db.delete_column(u'tigacrafting_userstat', 'grabbed_reports')
    ...
    models = {
        ...
        u'tigacrafting.annotation': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 5, 20, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 5, 20, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
        ...
        u'tigaserver_app.photo': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'2c862b9a-ac3b-4b88-b445-eb09c6df99c4'", 'max_length': '36'})
        },
