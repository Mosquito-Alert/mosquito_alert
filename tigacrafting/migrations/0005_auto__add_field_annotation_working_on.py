...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Annotation.working_on'
        db.add_column(u'tigacrafting_annotation', 'working_on',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Annotation.working_on'
        db.delete_column(u'tigacrafting_annotation', 'working_on')
    ...
    models = {
        ...
        u'tigaserver_app.photo': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'5d366e67-560f-4b65-9d23-afed0215fea7'", 'max_length': '36'})
        },
