...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ExpertReportAnnotation.linked_id'
        db.add_column(u'tigacrafting_expertreportannotation', 'linked_id',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=10, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ExpertReportAnnotation.linked_id'
        db.delete_column(u'tigacrafting_expertreportannotation', 'linked_id')
    ...
    models = {
        ...
        u'tigacrafting.annotation': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 7, 6, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 7, 6, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
        ...
        u'tigaserver_app.photo': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'f77a3bdc-6aa5-439b-8bed-23eea24b98aa'", 'max_length': '36'})
        },
