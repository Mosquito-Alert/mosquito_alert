...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ExpertUser'
        db.create_table(u'tigacrafting_expertuser', (
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True, primary_key=True)),
        ))
        db.send_create_signal(u'tigacrafting', ['ExpertUser'])


    def backwards(self, orm):
        # Deleting model 'ExpertUser'
        db.delete_table(u'tigacrafting_expertuser')
    ...
    models = {
        ...
        u'tigacrafting.expertuser': {
            'Meta': {'object_name': 'ExpertUser'},
        ...
        u'tigaserver_app.photo': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'c77997d0-9286-4aac-a71c-5631ca98a273'", 'max_length': '36'})
        },
