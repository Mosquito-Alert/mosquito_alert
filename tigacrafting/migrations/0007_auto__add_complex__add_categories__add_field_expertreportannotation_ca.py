...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'tigacrafting_complex', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('description', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal(u'tigacrafting', ['Complex'])

        # Adding model 'Categories'
        db.create_table(u'tigacrafting_categories', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.TextField')()),
            ('specify_certainty_level', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal(u'tigacrafting', ['Categories'])

        # Adding field 'ExpertReportAnnotation.category'
        db.add_column(u'tigacrafting_expertreportannotation', 'category',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='expert_report_annotations', null=True, to=orm['tigacrafting.Categories']),
                      keep_default=False)

        # Adding field 'ExpertReportAnnotation.complex'
        db.add_column(u'tigacrafting_expertreportannotation', 'complex',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='expert_report_annotations', null=True, to=orm['tigacrafting.Complex']),
                      keep_default=False)

        # Adding field 'ExpertReportAnnotation.validation_value'
        db.add_column(u'tigacrafting_expertreportannotation', 'validation_value',
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'tigacrafting_complex')

        # Deleting model 'Categories'
        db.delete_table(u'tigacrafting_categories')

        # Deleting field 'ExpertReportAnnotation.category'
        db.delete_column(u'tigacrafting_expertreportannotation', 'category_id')

        # Deleting field 'ExpertReportAnnotation.complex'
        db.delete_column(u'tigacrafting_expertreportannotation', 'complex_id')

        # Deleting field 'ExpertReportAnnotation.validation_value'
        db.delete_column(u'tigacrafting_expertreportannotation', 'validation_value')
    ...
    models = {
        ...
        u'tigacrafting.annotation': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2020, 4, 16, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2020, 4, 16, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
        ...
        u'tigaserver_app.photo': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'986c8c8a-2865-4276-87f3-d003df602045'", 'max_length': '36'})
        },
