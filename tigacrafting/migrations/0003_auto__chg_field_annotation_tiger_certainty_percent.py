...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Annotation.tiger_certainty_percent'
        db.alter_column(u'tigacrafting_annotation', 'tiger_certainty_percent', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'Annotation.tiger_certainty_percent'
        db.alter_column(u'tigacrafting_annotation', 'tiger_certainty_percent', self.gf('django.db.models.fields.FloatField')(null=True))
    ...
    models = {
        ...
        u'tigaserver_app.photo': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'b6e61125-196e-4afe-985e-47be29b5301b'", 'max_length': '36'})
        },
