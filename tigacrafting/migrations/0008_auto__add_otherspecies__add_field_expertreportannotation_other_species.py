...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'OtherSpecies'
        db.create_table(u'tigacrafting_otherspecies', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal(u'tigacrafting', ['OtherSpecies'])

        # Adding field 'ExpertReportAnnotation.other_species'
        db.add_column(u'tigacrafting_expertreportannotation', 'other_species',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='expert_report_annotations', null=True, to=orm['tigacrafting.OtherSpecies']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'OtherSpecies'
        db.delete_table(u'tigacrafting_otherspecies')

        # Deleting field 'ExpertReportAnnotation.other_species'
        db.delete_column(u'tigacrafting_expertreportannotation', 'other_species_id')
    ...
    models = {
        ...
        u'tigacrafting.annotation': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2020, 5, 5, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2020, 5, 5, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
        ...
        u'tigaserver_app.photo': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'f78d448c-70a5-487b-835c-767af0dfc873'", 'max_length': '36'})
        },
