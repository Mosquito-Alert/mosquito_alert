...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'OtherSpecies.category'
        db.add_column(u'tigacrafting_otherspecies', 'category',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'OtherSpecies.category'
        db.delete_column(u'tigacrafting_otherspecies', 'category')
    ...
    models = {
        ...
        u'tigacrafting.annotation': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2020, 5, 6, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2020, 5, 6, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
        ...
        u'tigaserver_app.photo': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'9abdce49-fa20-4495-be7c-61f8ed7fbbdf'", 'max_length': '36'})
        },
