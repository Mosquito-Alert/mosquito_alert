...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ExpertReportAnnotation.tiger_certainty_category'
        db.alter_column(u'tigacrafting_expertreportannotation', 'tiger_certainty_category', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'ExpertReportAnnotation.site_certainty_category'
        db.alter_column(u'tigacrafting_expertreportannotation', 'site_certainty_category', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'ExpertReportAnnotation.tiger_certainty_category'
        db.alter_column(u'tigacrafting_expertreportannotation', 'tiger_certainty_category', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'ExpertReportAnnotation.site_certainty_category'
        db.alter_column(u'tigacrafting_expertreportannotation', 'site_certainty_category', self.gf('django.db.models.fields.IntegerField')())
    ...
    models = {
        ...
        u'tigacrafting.annotation': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 7, 14, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 7, 14, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
        ...
        u'tigacrafting.expertreportannotation': {
            ...
            'site_certainty_category': ('django.db.models.fields.IntegerField', [], {'default': '-3', 'null': 'True', 'blank': 'True'}),
            'site_certainty_notes': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'status': ('django.db.models.fields.IntegerField', [], {'default': '1'}),
            'tiger_certainty_category': ('django.db.models.fields.IntegerField', [], {'default': '-3', 'null': 'True', 'blank': 'True'}),
        ...
        u'tigaserver_app.photo': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'3d221cc8-b24b-4023-9d00-d435584631e9'", 'max_length': '36'})
        },
