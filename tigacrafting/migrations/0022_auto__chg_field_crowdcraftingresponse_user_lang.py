...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CrowdcraftingResponse.user_lang'
        db.alter_column(u'tigacrafting_crowdcraftingresponse', 'user_lang', self.gf('django.db.models.fields.CharField')(max_length=10))

    def backwards(self, orm):

        # Changing field 'CrowdcraftingResponse.user_lang'
        db.alter_column(u'tigacrafting_crowdcraftingresponse', 'user_lang', self.gf('django.db.models.fields.CharField')(max_length=2))
    ...
    models = {
        ...
        u'tigacrafting.annotation': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 10, 2, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 10, 2, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
        ...
        u'tigaserver_app.photo': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'06dcf329-8643-4df5-bf8b-93658f260934'", 'max_length': '36'})
        },
