...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Annotation.tiger_certainty_cats'
        db.delete_column(u'tigacrafting_annotation', 'tiger_certainty_cats')

        # Deleting field 'Annotation.tiger_certainty_bool'
        db.delete_column(u'tigacrafting_annotation', 'tiger_certainty_bool')


    def backwards(self, orm):
        # Adding field 'Annotation.tiger_certainty_cats'
        db.add_column(u'tigacrafting_annotation', 'tiger_certainty_cats',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Annotation.tiger_certainty_bool'
        db.add_column(u'tigacrafting_annotation', 'tiger_certainty_bool',
    ...
    models = {
        ...
        u'tigacrafting.annotation': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 11, 8, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 11, 8, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
        ...
        u'tigaserver_app.photo': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'cf1c79b1-8c62-4ad4-aaa3-53e9b7d49bc2'", 'max_length': '36'})
        },
