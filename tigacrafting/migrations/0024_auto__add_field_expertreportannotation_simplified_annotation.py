...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ExpertReportAnnotation.simplified_annotation'
        db.add_column(u'tigacrafting_expertreportannotation', 'simplified_annotation',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ExpertReportAnnotation.simplified_annotation'
        db.delete_column(u'tigacrafting_expertreportannotation', 'simplified_annotation')
    ...
    models = {
        ...
        u'tigacrafting.annotation': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 5, 19, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 5, 19, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
        ...
        u'tigaserver_app.photo': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'fb97d42f-105b-4c4f-8dd9-8be6c1063401'", 'max_length': '36'})
        },
