...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'tigacrafting_expertreportannotation', 'species',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='validations', null=True, to=orm['tigacrafting.Species']),
                      keep_default=False)
    ...
    models = {
        ...
        u'tigaserver_app.photo': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'bfe5294a-dd15-4123-abd4-7351eaef32c4'", 'max_length': '36'})
        },
