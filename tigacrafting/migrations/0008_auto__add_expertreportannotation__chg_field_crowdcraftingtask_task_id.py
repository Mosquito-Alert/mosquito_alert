...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'tigacrafting_expertreportannotation', (
            ...
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='expert_report_annotation', to=orm['auth.User'])),
            ('report', self.gf('django.db.models.fields.related.ForeignKey')(related_name='expert_report_annotation', to=orm['tigaserver_app.Report'])),
            ...
            ('site_certainty_category', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ...
            ('last_modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2015, 6, 2, 0, 0), auto_now=True, blank=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2015, 6, 2, 0, 0), auto_now_add=True, blank=True)),
        ))
        db.send_create_signal(u'tigacrafting', ['ExpertReportAnnotation'])


        # Changing field 'CrowdcraftingTask.task_id'
        db.alter_column(u'tigacrafting_crowdcraftingtask', 'task_id', self.gf('django.db.models.fields.IntegerField')(unique=True, null=True))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'CrowdcraftingTask.task_id'
        db.alter_column(u'tigacrafting_crowdcraftingtask', 'task_id', self.gf('django.db.models.fields.IntegerField')(default=None, unique=True))
    ...
    models = {
        ...
        u'tigacrafting.annotation': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 6, 2, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 6, 2, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
        ...
        u'tigacrafting.expertreportannotation': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 6, 2, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
            'report': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'expert_report_annotation'", 'to': u"orm['tigaserver_app.Report']"}),
            ...
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'expert_report_annotation'", 'to': u"orm['auth.User']"})
        },
        ...
        u'tigaserver_app.photo': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'3042d30a-55c1-4ea1-875a-71bd1b2db0f6'", 'max_length': '36'})
        },
