...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'ExpertReportAnnotation.species'
        db.delete_column(u'tigacrafting_expertreportannotation', 'species_id')
    ...
    def backwards(self, orm):
        ...
        # Adding field 'ExpertReportAnnotation.species'
        db.add_column(u'tigacrafting_expertreportannotation', 'species',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='validations', null=True, to=orm['tigacrafting.Species'], blank=True),
                      keep_default=False)
    ...
    models = {
        ...
        u'tigaserver_app.photo': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'54006344-522a-4422-ae06-c9140a73b51d'", 'max_length': '36'})
        },
