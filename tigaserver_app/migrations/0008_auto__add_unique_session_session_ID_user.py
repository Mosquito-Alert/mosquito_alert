...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Session', fields ['session_ID', 'user']
        db.create_unique(u'tigaserver_app_session', ['session_ID', 'user_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Session', fields ['session_ID', 'user']
        db.delete_unique(u'tigaserver_app_session', ['session_ID', 'user_id'])
    ...
    models = {
        ...
        u'tigaserver_app.photo': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'0ece9c55-4d15-454d-b1fa-5d5295f320a5'", 'max_length': '36'})
        },
