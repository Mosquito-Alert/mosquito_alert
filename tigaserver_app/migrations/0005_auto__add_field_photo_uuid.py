...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Photo.uuid'
        db.add_column(u'tigaserver_app_photo', 'uuid',
                      self.gf('django.db.models.fields.CharField')(default='71d62359-1718-441b-9d7a-63bb5f974a70', max_length=36),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Photo.uuid'
        db.delete_column(u'tigaserver_app_photo', 'uuid')
    ...
    models = {
        ...
        u'tigaserver_app.photo': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'734b36f2-a3c1-43ec-8551-b0890a3df915'", 'max_length': '36'})
        },
