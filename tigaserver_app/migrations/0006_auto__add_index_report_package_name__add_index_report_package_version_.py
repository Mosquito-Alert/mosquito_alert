...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'Report', fields ['package_name']
        db.create_index(u'tigaserver_app_report', ['package_name'])

        # Adding index on 'Report', fields ['package_version']
        db.create_index(u'tigaserver_app_report', ['package_version'])

        # Adding index on 'Report', fields ['report_id']
        db.create_index(u'tigaserver_app_report', ['report_id'])

        # Adding index on 'Report', fields ['version_number']
        db.create_index(u'tigaserver_app_report', ['version_number'])


    def backwards(self, orm):
        # Removing index on 'Report', fields ['version_number']
        db.delete_index(u'tigaserver_app_report', ['version_number'])

        # Removing index on 'Report', fields ['report_id']
        db.delete_index(u'tigaserver_app_report', ['report_id'])

        # Removing index on 'Report', fields ['package_version']
        db.delete_index(u'tigaserver_app_report', ['package_version'])

        # Removing index on 'Report', fields ['package_name']
        db.delete_index(u'tigaserver_app_report', ['package_name'])
    ...
    models = {
        ...
        u'tigaserver_app.photo': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'fc2a61ba-5485-4c93-add9-735e62907d09'", 'max_length': '36'})
        },
