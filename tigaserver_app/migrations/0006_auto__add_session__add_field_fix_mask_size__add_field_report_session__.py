...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'tigaserver_app_session', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('session_ID', self.gf('django.db.models.fields.IntegerField')(db_index=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='user_sessions', to=orm['tigaserver_app.TigaUser'])),
            ('session_start_time', self.gf('django.db.models.fields.DateTimeField')()),
            ('session_end_time', self.gf('django.db.models.fields.DateTimeField')()),
        ))
        db.send_create_signal(u'tigaserver_app', ['Session'])

        # Adding field 'Fix.mask_size'
        db.add_column(u'tigaserver_app_fix', 'mask_size',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Report.session'
        db.add_column(u'tigaserver_app_report', 'session',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='session_reports', null=True, to=orm['tigaserver_app.Session']),
                      keep_default=False)

        # Adding field 'ReportResponse.question_id'
        db.add_column(u'tigaserver_app_reportresponse', 'question_id',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'ReportResponse.answer_id'
        db.add_column(u'tigaserver_app_reportresponse', 'answer_id',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'tigaserver_app_session')

        # Deleting field 'Fix.mask_size'
        db.delete_column(u'tigaserver_app_fix', 'mask_size')

        # Deleting field 'Report.session'
        db.delete_column(u'tigaserver_app_report', 'session_id')

        # Deleting field 'ReportResponse.question_id'
        db.delete_column(u'tigaserver_app_reportresponse', 'question_id')

        # Deleting field 'ReportResponse.answer_id'
        db.delete_column(u'tigaserver_app_reportresponse', 'answer_id')
    ...
    models = {
        ...
        u'tigaserver_app.fix': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'mask_size': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
        ...
        u'tigaserver_app.notification': {
            ...
            'date_comment': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2020, 3, 5, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
        ...
        u'tigaserver_app.photo': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'8fd665d5-e002-4173-b9e4-4d5b9125769f'", 'max_length': '36'})
        },
        u'tigaserver_app.report': {
            ...
            'server_upload_time': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'session': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'session_reports'", 'null': 'True', 'to': u"orm['tigaserver_app.Session']"}),
        ...
        u'tigaserver_app.reportresponse': {
            ...
            'answer_id': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'tigaserver_app.session': {
            'Meta': {'object_name': 'Session'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'session_ID': ('django.db.models.fields.IntegerField', [], {'db_index': 'True'}),
            'session_end_time': ('django.db.models.fields.DateTimeField', [], {}),
            'session_start_time': ('django.db.models.fields.DateTimeField', [], {}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'user_sessions'", 'to': u"orm['tigaserver_app.TigaUser']"})
        },
