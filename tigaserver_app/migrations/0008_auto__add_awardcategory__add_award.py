...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'AwardCategory'
        db.create_table(u'tigaserver_app_awardcategory', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('category_label', self.gf('django.db.models.fields.TextField')()),
            ('xp_points', self.gf('django.db.models.fields.IntegerField')()),
            ('category_long_description', self.gf('django.db.models.fields.TextField')(default=None, null=True, blank=True)),
        ))
        db.send_create_signal(u'tigaserver_app', ['AwardCategory'])

        # Adding model 'Award'
        db.create_table(u'tigaserver_app_award', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('report', self.gf('django.db.models.fields.related.ForeignKey')(related_name='report_award', blank=True, to=orm['tigaserver_app.Report'])),
            ('date_given', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2020, 5, 19, 0, 0), auto_now_add=True, blank=True)),
            ('given_to', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='user_awards', null=True, to=orm['tigaserver_app.TigaUser'])),
            ('expert', self.gf('django.db.models.fields.related.ForeignKey')(related_name='expert_awards', blank=True, to=orm['auth.User'])),
            ('category', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='category_awards', null=True, to=orm['tigaserver_app.AwardCategory'])),
            ('special_award_text', self.gf('django.db.models.fields.TextField')(default=None, null=True, blank=True)),
            ('special_award_xp', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal(u'tigaserver_app', ['Award'])


    def backwards(self, orm):
        # Deleting model 'AwardCategory'
        db.delete_table(u'tigaserver_app_awardcategory')

        # Deleting model 'Award'
        db.delete_table(u'tigaserver_app_award')
    ...
    models = {
        ...
        u'tigaserver_app.award': {
            'Meta': {'object_name': 'Award'},
            'category': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'category_awards'", 'null': 'True', 'to': u"orm['tigaserver_app.AwardCategory']"}),
            'date_given': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2020, 5, 19, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
            'expert': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'expert_awards'", 'blank': 'True', 'to': u"orm['auth.User']"}),
            'given_to': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'user_awards'", 'null': 'True', 'to': u"orm['tigaserver_app.TigaUser']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'report': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'report_award'", 'blank': 'True', 'to': u"orm['tigaserver_app.Report']"}),
            'special_award_text': ('django.db.models.fields.TextField', [], {'default': 'None', 'null': 'True', 'blank': 'True'}),
            'special_award_xp': ('django.db.models.fields.IntegerField', [], {})
        },
        u'tigaserver_app.awardcategory': {
            'Meta': {'object_name': 'AwardCategory'},
            'category_label': ('django.db.models.fields.TextField', [], {}),
            'category_long_description': ('django.db.models.fields.TextField', [], {'default': 'None', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'xp_points': ('django.db.models.fields.IntegerField', [], {})
        },
        ...
        u'tigaserver_app.notification': {
            ...
            'date_comment': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2020, 5, 19, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
        ...
        u'tigaserver_app.photo': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'c54b476f-06d7-4aa2-ae5e-ebd112c23009'", 'max_length': '36'})
        },
