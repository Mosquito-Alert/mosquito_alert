...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'NotificationContent.default_locale'
        db.add_column(u'tigaserver_app_notificationcontent', 'default_locale',
                      self.gf('django.db.models.fields.CharField')(default='es', max_length=4),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'NotificationContent.default_locale'
        db.delete_column(u'tigaserver_app_notificationcontent', 'default_locale')
    ...
    models = {
        ...
        u'tigaserver_app.photo': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'a7ca8480-84a9-4d47-8d9e-98beb667b3ca'", 'max_length': '36'})
        },
