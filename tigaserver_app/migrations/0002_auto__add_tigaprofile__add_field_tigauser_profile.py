...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'TigaProfile'
        db.create_table(u'tigaserver_app_tigaprofile', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('firebase_token', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('score', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ))
        db.send_create_signal(u'tigaserver_app', ['TigaProfile'])

        # Adding field 'TigaUser.profile'
        db.add_column(u'tigaserver_app_tigauser', 'profile',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='profile_devices', null=True, to=orm['tigaserver_app.TigaProfile']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'TigaProfile'
        db.delete_table(u'tigaserver_app_tigaprofile')

        # Deleting field 'TigaUser.profile'
        db.delete_column(u'tigaserver_app_tigauser', 'profile_id')
    ...
    models = {
        ...
        u'tigaserver_app.notification': {
            ...
            'date_comment': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2018, 3, 6, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
        ...
        u'tigaserver_app.photo': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'9cdc5413-3fe1-474d-bbd3-ebffbcbb6543'", 'max_length': '36'})
        },
        ...
        u'tigaserver_app.tigaprofile': {
            ...
            'firebase_token': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
