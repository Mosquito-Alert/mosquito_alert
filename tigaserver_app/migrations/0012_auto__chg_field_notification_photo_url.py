...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Notification.photo_url'
        db.alter_column(u'tigaserver_app_notification', 'photo_url', self.gf('django.db.models.fields.TextField')(null=True))

    def backwards(self, orm):

        # Changing field 'Notification.photo_url'
        db.alter_column(u'tigaserver_app_notification', 'photo_url', self.gf('django.db.models.fields.TextField')(default=''))
    ...
    models = {
        ...
        u'tigaserver_app.notification': {
            ...
            'date_comment': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 6, 28, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
        ...
        u'tigaserver_app.photo': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'90e686da-5abc-4a25-8dda-58bbe5456dfe'", 'max_length': '36'})
        },
