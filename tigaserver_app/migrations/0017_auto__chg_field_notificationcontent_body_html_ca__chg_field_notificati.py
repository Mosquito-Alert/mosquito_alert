...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'NotificationContent.body_html_ca'
        db.alter_column(u'tigaserver_app_notificationcontent', 'body_html_ca', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'NotificationContent.title_en'
        db.alter_column(u'tigaserver_app_notificationcontent', 'title_en', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'NotificationContent.title_ca'
        db.alter_column(u'tigaserver_app_notificationcontent', 'title_ca', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'NotificationContent.body_html_en'
        db.alter_column(u'tigaserver_app_notificationcontent', 'body_html_en', self.gf('django.db.models.fields.TextField')(null=True))

    def backwards(self, orm):

        # Changing field 'NotificationContent.body_html_ca'
        db.alter_column(u'tigaserver_app_notificationcontent', 'body_html_ca', self.gf('django.db.models.fields.TextField')(default=None))

        # Changing field 'NotificationContent.title_en'
        db.alter_column(u'tigaserver_app_notificationcontent', 'title_en', self.gf('django.db.models.fields.TextField')(default=None))

        # Changing field 'NotificationContent.title_ca'
        db.alter_column(u'tigaserver_app_notificationcontent', 'title_ca', self.gf('django.db.models.fields.TextField')(default=None))

        # Changing field 'NotificationContent.body_html_en'
        db.alter_column(u'tigaserver_app_notificationcontent', 'body_html_en', self.gf('django.db.models.fields.TextField')(default=None))
    ...
    models = {
        ...
        u'tigaserver_app.notification': {
            ...
            'date_comment': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2017, 3, 7, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
        ...
        u'tigaserver_app.notificationcontent': {
            ...
            'default_locale': ('django.db.models.fields.CharField', [], {'default': "'es'", 'max_length': '4'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'tigaserver_app.photo': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'bb12b924-a19c-4fe2-9150-b8e0b955fa8c'", 'max_length': '36'})
        },
