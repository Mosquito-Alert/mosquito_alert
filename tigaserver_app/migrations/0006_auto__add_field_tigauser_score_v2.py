...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TigaUser.score_v2'
        db.add_column(u'tigaserver_app_tigauser', 'score_v2',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TigaUser.score_v2'
        db.delete_column(u'tigaserver_app_tigauser', 'score_v2')
    ...
    models = {
        ...
        u'tigaserver_app.notification': {
            ...
            'date_comment': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2020, 4, 30, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
        ...
        u'tigaserver_app.photo': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'2919dd8c-3a14-4215-bad7-be51f0f692d3'", 'max_length': '36'})
        },
