...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'tigaserver_app_tigauser', (
            ...
            ('registration_time', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('device_token', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
        ...
        db.create_table(u'tigaserver_app_mission', (
            ...
            ('mission_version', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
        ))
        ...
        db.create_table(u'tigaserver_app_report', (
            ...
            ('version_number', self.gf('django.db.models.fields.IntegerField')(db_index=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['tigaserver_app.TigaUser'])),
            ('report_id', self.gf('django.db.models.fields.CharField')(max_length=4, db_index=True)),
            ...
            ('package_name', self.gf('django.db.models.fields.CharField')(db_index=True, max_length=400, blank=True)),
            ('package_version', self.gf('django.db.models.fields.IntegerField')(db_index=True, null=True, blank=True)),
            ...
            ('os_language', self.gf('django.db.models.fields.CharField')(max_length=10, blank=True)),
            ('app_language', self.gf('django.db.models.fields.CharField')(max_length=10, blank=True)),
        ...
        db.create_table(u'tigaserver_app_photo', (
            ...
            ('report', self.gf('django.db.models.fields.related.ForeignKey')(related_name='photos', to=orm['tigaserver_app.Report'])),
            ('hide', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('uuid', self.gf('django.db.models.fields.CharField')(default='f3457aac-addf-4973-8c3b-18aa722cbae7', max_length=36)),
        ))
        ...
        db.create_table(u'tigaserver_app_fix', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user_coverage_uuid', self.gf('django.db.models.fields.CharField')(max_length=36, null=True, blank=True)),
        ...
        # Adding model 'CoverageAreaMonth'
        db.create_table(u'tigaserver_app_coverageareamonth', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('lat', self.gf('django.db.models.fields.FloatField')()),
            ('lon', self.gf('django.db.models.fields.FloatField')()),
        ...
        db.send_create_signal(u'tigaserver_app', ['CoverageAreaMonth'])

        # Adding unique constraint on 'CoverageAreaMonth', fields ['lat', 'lon', 'year', 'month']
        db.create_unique(u'tigaserver_app_coverageareamonth', ['lat', 'lon', 'year', 'month'])

        # Adding model 'NotificationContent'
        db.create_table(u'tigaserver_app_notificationcontent', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal(u'tigaserver_app', ['NotificationContent'])
        ...
        db.create_table(u'tigaserver_app_notification', (
            ...
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='user_notifications', to=orm['tigaserver_app.TigaUser'])),
            ('expert', self.gf('django.db.models.fields.related.ForeignKey')(related_name='expert_notifications', blank=True, to=orm['auth.User'])),
            ('date_comment', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2018, 3, 1, 0, 0), auto_now_add=True, blank=True)),
            ('notification_content', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='notification_content', null=True, to=orm['tigaserver_app.NotificationContent'])),
            ('expert_comment', self.gf('django.db.models.fields.TextField')()),
            ('expert_html', self.gf('django.db.models.fields.TextField')()),
            ('photo_url', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
    ...
    def backwards(self, orm):
        # Removing unique constraint on 'CoverageAreaMonth', fields ['lat', 'lon', 'year', 'month']
        db.delete_unique(u'tigaserver_app_coverageareamonth', ['lat', 'lon', 'year', 'month'])
        ...
        # Deleting model 'CoverageAreaMonth'
        db.delete_table(u'tigaserver_app_coverageareamonth')

        # Deleting model 'NotificationContent'
        db.delete_table(u'tigaserver_app_notificationcontent')
    ...
    models = {
        ...
        u'tigaserver_app.notification': {
            ...
            'date_comment': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2018, 3, 1, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
        ...
        u'tigaserver_app.photo': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'5cc7b897-df8c-4bdb-ba0a-c67f4180350c'", 'max_length': '36'})
        },
