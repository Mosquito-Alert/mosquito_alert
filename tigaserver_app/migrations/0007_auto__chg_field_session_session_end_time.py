...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Session.session_end_time'
        db.alter_column(u'tigaserver_app_session', 'session_end_time', self.gf('django.db.models.fields.DateTimeField')(null=True))

    def backwards(self, orm):

        # Changing field 'Session.session_end_time'
        db.alter_column(u'tigaserver_app_session', 'session_end_time', self.gf('django.db.models.fields.DateTimeField')(default=None))
    ...
    models = {
        ...
        u'tigaserver_app.photo': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'7acbe769-e326-4774-b252-ba5d9352b082'", 'max_length': '36'})
        },
