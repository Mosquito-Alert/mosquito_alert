...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'TigaUser.device_token'
        db.alter_column(u'tigaserver_app_tigauser', 'device_token', self.gf('django.db.models.fields.TextField')(null=True))

    def backwards(self, orm):

        # Changing field 'TigaUser.device_token'
        db.alter_column(u'tigaserver_app_tigauser', 'device_token', self.gf('django.db.models.fields.CharField')(default='', max_length=100))
    ...
    models = {
        ...
        u'tigaserver_app.photo': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'250d5303-9db5-479e-8c2f-844fd5526d68'", 'max_length': '36'})
        },
