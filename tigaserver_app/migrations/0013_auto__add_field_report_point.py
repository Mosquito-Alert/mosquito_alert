...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Report.point'
        db.add_column(u'tigaserver_app_report', 'point',
                      self.gf('django.contrib.gis.db.models.fields.PointField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Report.point'
        db.delete_column(u'tigaserver_app_report', 'point')
    ...
    models = {
        ...
        u'tigaserver_app.notification': {
            ...
            'date_comment': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2017, 3, 6, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
        ...
        u'tigaserver_app.photo': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'10e9bae1-ea5c-4807-b6bd-d320ec3205eb'", 'max_length': '36'})
        },
