...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'TigaProfile', fields ['firebase_token']
        db.create_unique(u'tigaserver_app_tigaprofile', ['firebase_token'])


    def backwards(self, orm):
        # Removing unique constraint on 'TigaProfile', fields ['firebase_token']
        db.delete_unique(u'tigaserver_app_tigaprofile', ['firebase_token'])
    ...
    models = {
        ...
        u'tigaserver_app.photo': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'3f4893f0-f85c-40ec-9dc4-c061aa0f99b1'", 'max_length': '36'})
        },
