...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Report.os_language'
        db.alter_column(u'tigaserver_app_report', 'os_language', self.gf('django.db.models.fields.CharField')(max_length=10))

        # Changing field 'Report.app_language'
        db.alter_column(u'tigaserver_app_report', 'app_language', self.gf('django.db.models.fields.CharField')(max_length=10))

    def backwards(self, orm):

        # Changing field 'Report.os_language'
        db.alter_column(u'tigaserver_app_report', 'os_language', self.gf('django.db.models.fields.CharField')(max_length=2))

        # Changing field 'Report.app_language'
        db.alter_column(u'tigaserver_app_report', 'app_language', self.gf('django.db.models.fields.CharField')(max_length=2))
    ...
    models = {
        ...
        u'tigaserver_app.photo': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'cc3cd7cd-5f51-467b-b9f3-2f32bc8ef9be'", 'max_length': '36'})
        },
