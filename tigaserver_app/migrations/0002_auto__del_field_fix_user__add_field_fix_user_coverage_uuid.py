...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Fix.user'
        db.delete_column(u'tigaserver_app_fix', 'user_id')

        # Adding field 'Fix.user_coverage_uuid'
        db.add_column(u'tigaserver_app_fix', 'user_coverage_uuid',
                      self.gf('django.db.models.fields.CharField')(max_length=36, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Fix.user'
        db.add_column(u'tigaserver_app_fix', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='tttttttttttttttttttttttttttttttttttt', to=orm['tigaserver_app.TigaUser']),
                      keep_default=False)

        # Deleting field 'Fix.user_coverage_uuid'
        db.delete_column(u'tigaserver_app_fix', 'user_coverage_uuid')
