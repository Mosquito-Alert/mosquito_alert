...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Photo.hide'
        db.add_column(u'tigaserver_app_photo', 'hide',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Report.hide'
        db.add_column(u'tigaserver_app_report', 'hide',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Photo.hide'
        db.delete_column(u'tigaserver_app_photo', 'hide')

        # Deleting field 'Report.hide'
        db.delete_column(u'tigaserver_app_report', 'hide')
