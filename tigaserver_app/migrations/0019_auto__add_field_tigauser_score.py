...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TigaUser.score'
        db.add_column(u'tigaserver_app_tigauser', 'score',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TigaUser.score'
        db.delete_column(u'tigaserver_app_tigauser', 'score')
    ...
    models = {
        ...
        u'tigaserver_app.notification': {
            ...
            'date_comment': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2017, 4, 21, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
        ...
        u'tigaserver_app.photo': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'a450efc4-069e-49cf-a884-1bc5fc71c874'", 'max_length': '36'})
        },
