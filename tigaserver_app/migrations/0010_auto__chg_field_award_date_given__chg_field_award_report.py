...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Award.date_given'
        db.alter_column(u'tigaserver_app_award', 'date_given', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'Award.report'
        db.alter_column(u'tigaserver_app_award', 'report_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['tigaserver_app.Report']))

    def backwards(self, orm):

        # Changing field 'Award.date_given'
        db.alter_column(u'tigaserver_app_award', 'date_given', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'Award.report'
        db.alter_column(u'tigaserver_app_award', 'report_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['tigaserver_app.Report']))
    ...
    models = {
        ...
        u'tigaserver_app.award': {
            ...
            'date_given': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2020, 5, 21, 0, 0)'}),
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'report': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'related_name': "'report_award'", 'null': 'True', 'blank': 'True', 'to': u"orm['tigaserver_app.Report']"}),
            'special_award_text': ('django.db.models.fields.TextField', [], {'default': 'None', 'null': 'True', 'blank': 'True'}),
            'special_award_xp': ('django.db.models.fields.IntegerField', [], {'default': '0', 'null': 'True', 'blank': 'True'})
        },
        ...
        u'tigaserver_app.notification': {
            ...
            'date_comment': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2020, 5, 21, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
        ...
        u'tigaserver_app.photo': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'da6da780-08ad-4f25-9df9-aaf4ddf5ba34'", 'max_length': '36'})
        },
