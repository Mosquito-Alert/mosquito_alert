...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'tigaserver_app_notificationcontent', (
            ...
            ('body_html_ca', self.gf('django.db.models.fields.TextField')()),
            ('body_html_en', self.gf('django.db.models.fields.TextField')()),
            ('title_es', self.gf('django.db.models.fields.TextField')()),
            ('title_ca', self.gf('django.db.models.fields.TextField')()),
            ('title_en', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal(u'tigaserver_app', ['NotificationContent'])

        # Adding field 'Notification.notification_content'
        db.add_column(u'tigaserver_app_notification', 'notification_content',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='notification_content', null=True, to=orm['tigaserver_app.NotificationContent']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Notification.notification_content'
        db.delete_column(u'tigaserver_app_notification', 'notification_content_id')
    ...
    models = {
        ...
        u'tigaserver_app.notificationcontent': {
            ...
            'body_html_ca': ('django.db.models.fields.TextField', [], {}),
            'body_html_en': ('django.db.models.fields.TextField', [], {}),
            'body_html_es': ('django.db.models.fields.TextField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'title_ca': ('django.db.models.fields.TextField', [], {}),
        ...
        u'tigaserver_app.photo': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'8ca6dc25-e799-4398-b8f0-6bdf84a7cb92'", 'max_length': '36'})
        },
