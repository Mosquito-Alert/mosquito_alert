...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Award.special_award_xp'
        db.alter_column(u'tigaserver_app_award', 'special_award_xp', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'Award.special_award_xp'
        db.alter_column(u'tigaserver_app_award', 'special_award_xp', self.gf('django.db.models.fields.IntegerField')(default=0))
    ...
    models = {
        ...
        u'tigaserver_app.award': {
            ...
            'date_given': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2020, 5, 20, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
        ...
        u'tigaserver_app.notification': {
            ...
            'date_comment': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2020, 5, 20, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
        ...
        u'tigaserver_app.photo': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'75e9d321-5f36-4764-9a75-b773c7696e7a'", 'max_length': '36'})
        },
