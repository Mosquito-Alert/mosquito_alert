...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ReportResponse.answer_value'
        db.add_column(u'tigaserver_app_reportresponse', 'answer_value',
                      self.gf('django.db.models.fields.CharField')(max_length=1000, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ReportResponse.answer_value'
        db.delete_column(u'tigaserver_app_reportresponse', 'answer_value')
    ...
    models = {
        ...
        u'tigaserver_app.notification': {
            ...
            'date_comment': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2020, 4, 2, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
        ...
        u'tigaserver_app.photo': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'6f2a567e-18f6-415a-b014-f4292f3b512f'", 'max_length': '36'})
        },
        ...
        u'tigaserver_app.reportresponse': {
            ...
            'answer_value': ('django.db.models.fields.CharField', [], {'max_length': '1000', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'tigaserver_app.session': {
            'Meta': {'unique_together': "(('session_ID', 'user'),)", 'object_name': 'Session'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'session_ID': ('django.db.models.fields.IntegerField', [], {'db_index': 'True'}),
            'session_end_time': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
