...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Notification.user'
        db.alter_column(u'tigaserver_app_notification', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['tigaserver_app.TigaUser']))

    def backwards(self, orm):

        # Changing field 'Notification.user'
        db.alter_column(u'tigaserver_app_notification', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))
    ...
    models = {
        ...
        u'tigaserver_app.photo': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'27ac85b7-e9aa-4088-bc2a-14416c762ecc'", 'max_length': '36'})
        },
