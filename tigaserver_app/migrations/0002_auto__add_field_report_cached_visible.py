...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Report.cached_visible'
        db.add_column(u'tigaserver_app_report', 'cached_visible',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Report.cached_visible'
        db.delete_column(u'tigaserver_app_report', 'cached_visible')
    ...
    models = {
        ...
        u'tigaserver_app.notification': {
            ...
            'date_comment': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2018, 10, 16, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
        ...
        u'tigaserver_app.photo': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'681753a5-6183-47e4-b6de-1a4e79312333'", 'max_length': '36'})
        },
