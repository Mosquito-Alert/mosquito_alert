...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TigaUser.device_token'
        db.add_column(u'tigaserver_app_tigauser', 'device_token',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TigaUser.device_token'
        db.delete_column(u'tigaserver_app_tigauser', 'device_token')
    ...
    models = {
        ...
        u'tigaserver_app.notification': {
            ...
            'date_comment': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2017, 2, 28, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
        ...
        u'tigaserver_app.photo': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'c65270b5-4d43-4dd9-8c0e-168e6d4a2e95'", 'max_length': '36'})
        },
        ...
        u'tigaserver_app.tigauser': {
            ...
            'device_token': ('django.db.models.fields.CharField', [], {'default': 'None', 'max_length': '100', 'blank': 'True'}),
