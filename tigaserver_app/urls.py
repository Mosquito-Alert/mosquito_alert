...
urlpatterns = [
    ...
    url('msgs_ios/$', views.msgs_ios),
    url('msg_android/$', views.msg_android),
    url('msgs_android/$', views.msgs_android),
    ...
    url('accept_and_communicate_alert/$', views.accept_and_communicate_alert),
    url('n_alerts/$', views.n_alerts),
