...
class Session(models.Model):
    ...
    user = models.ForeignKey(TigaUser, help_text='user_UUID for the user sending this report. Must be exactly 36 characters (32 hex digits plus 4 hyphens) and user must have already registered this ID.', related_name="user_sessions")
...
class Report(models.Model):
    ...
    session = models.ForeignKey(Session, blank=True, null=True, help_text='Session ID for session in which this report was created ', related_name="session_reports")
