...
class TigaUser(models.Model):
    ...
    registration_time = models.DateTimeField(default=timezone.now, help_text='The date and time when user '
...
class Report(models.Model):
    ...
    server_upload_time = models.DateTimeField(default=timezone.now, help_text='Date and time on server when report '
...
class Fix(models.Model):
    ...
    fix_time = models.DateTimeField(help_text='Date and time when fix was recorded on phone. Format as ECMA '
                                              '262 date time string (e.g. "2014-05-17T12:34:56'
                                              '.123+01:00".')
    server_upload_time = models.DateTimeField(default=timezone.now, help_text='Date and time registered by server when '
