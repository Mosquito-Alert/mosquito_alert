...
class Report(models.Model):
    ...
    cached_movelab_annotation_euro = models.TextField(blank=True, null=True)

    cached_movelab_annotation_euro_last_update = models.DateTimeField(blank=True, null=True)
