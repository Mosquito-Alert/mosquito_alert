    ...
    session_start_time = models.DateTimeField(help_text='Date and time on phone when the session was started. '
                                                   'Format '
                                                       ...
                                                       '262 date time string (e.g. "2014-05-17T12:34:56'
                                                        '.123+01:00".')
    session_end_time = models.DateTimeField(help_text='Date and time on phone when the session was ended. '
                                                   'Format '
                                                       'as ECMA '
                                                       '262 date time string (e.g. "2014-05-17T12:34:56'
                                                       '.123+01:00".')
...
class Report(models.Model):
    ...
    session = models.ForeignKey(Session, TigaUser, help_text='Session ID for session in which this report was created ',
...
class ReportResponse(models.Model):
    ...
    answer_id = models.IntegerField(help_text='Numeric identifier of the answer.')
