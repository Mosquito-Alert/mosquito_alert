    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('boundaries', models.ManyToManyField(related_name='locations', to='geo.boundary')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('boundary', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='geometry_model', to='geo.boundary')),
            ],
            options={
