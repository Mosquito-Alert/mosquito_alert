...
from mosquito_alert.tigaserver_app.models import TigaUser, Report, Photo, Notification
...
class ScoringTestCase(TestCase):
    ...
    def test_first_of_season_awarded(self):
        ...
        report_in_season = self.create_single_report(settings.SEASON_START_DAY, settings.SEASON_START_MONTH, 2020, user, '00000000-0000-0000-0000-000000000002')
        report_in_season.save()
        ...
        report_in_other_season = self.create_single_report(settings.SEASON_START_DAY, settings.SEASON_START_MONTH, 2018, user, '00000000-0000-0000-0000-000000000003')
    ...
    def get_notification_body_en(category_label, xp):
        ...
        deactivate()
        return render_to_string('awards/award_notification_en.html', context_en).encode('ascii', 'xmlcharrefreplace').decode('UTF-8')
    ...
    def get_notification_body_for_locale(category_label, xp, locale):
        ...
        deactivate()
        return render_to_string('awards/award_notification_' + locale + '.html', context).encode('ascii', 'xmlcharrefreplace').decode('UTF-8')
    ...
    def test_10_report_achievement(self):
        ...
        if settings.DISABLE_ACHIEVEMENT_NOTIFICATIONS == False:
