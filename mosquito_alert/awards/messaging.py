...
def send_new_award_notification(award: 'mosquito_alert.awards.Award') -> None:
    ...
    def render_body_html(template_lang, context):
        try:
            result_template = render_to_string(f'awards/award_notification_{template_lang}.html', context)
        except TemplateDoesNotExist:
            result_template = render_to_string('awards/award_notification_en.html', context)
