...
class IdentificationTaskAdmin(NumericFilterModelAdmin):
    ...
    def get_queryset(self, request):
        return (
            ...
            .select_related("report__country", "taxon", "photo")
            .prefetch_related("expert_report_annotations", "photo_predictions")
        )

    inlines = [ExpertReportAnnotationInlineAdmin, PhotoPredictionInlineAdmin]
