...
DISABLE_PUSH = env.bool(
    "DISABLE_PUSH", default=True
)  # NOTE: This completely disables sending push notifications, independently of the FCM_DJANGO_SETTINGS. Used in dev and staging.
...
DISABLE_ACHIEVEMENT_NOTIFICATIONS = (
    False  # Completely disables notifications for achievements/rewards
)
MINIMUM_PACKAGE_VERSION_SCORING_NOTIFICATIONS = (
    32  # Minimum package version for scoring notifications
)
